...
from doc_parser.steps.step3_extract import run_extraction, parse_date_to_epoch, _strip_watermark_lines
...
class TestStripWatermarkLines:
    def test_removes_macroamy_lines(self):
        ...
        result = _strip_watermark_lines(md)
